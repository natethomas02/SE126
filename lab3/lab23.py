...
with open ("lab3/lab3a.csv") as csvfile:
    ...
    for rec in file: 
        ...
        if rec[5] == "1":
            hdd_2 = " "  # or "none" or any other appropriate value
            os = rec[6]
            year = rec[7]
...
print(f"To replace {new_desktop} Desktops it will cost: ${new_desktop * desktop_cost}")
print(f"To replace {new_laptop} Laptops it will cost: ${new_laptop * laptop_cost}")
